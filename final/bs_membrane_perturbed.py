...
npm = Atoms(symbols=(['Si'] * 96),
                    ...
                    pbc=[1, 1, 0],
                    scaled_positions=[
                    (0.0000,    0.00,    0.199299), #perturbed in z
                    ...
                    (0.2509,    0.00,    0.199999), # perturbed in x
                    ...
                    (0.3750,    0.50,    0.200699), #perturbed in z
                    ...
                    (0.6250,    0.5037,  0.199999), # perturbed in y
                    ...
                    (0.1875,    0.25,    0.750700), # perturbed in z
                    ...
                    (0.4375,    0.2463,  0.750000), # pertubed in y
                    ...
                    (0.6866,    0.25,    0.750000), # perturbed in x
                    ...
                    (0.8125,    0.75,    0.749300), # perturbed in z
...
# precon = PreconLBFGS(npm, precon=Exp(3.0))
# precon.run(fmax=0.03)
